...
Caso o usuário não forneça informações suficientes, explique que precisa de mais detalhes sobre o humor e compromissos para sugerir adequadamente e NUNCA responda com sugestões vagas ou genéricas.
Formato da resposta:  
...
<sugestao>[ideias de esmaltação e cores recomendadas, em tópicos; exemplos: “<item>francesinha colorida em tons pastel</item>”, “<item>nude clássico para ocasiões formais</item>”, “<item>tons metálicos para combinar com bom humor</item>” etc.]</sugestao>
...
Exemplo 2  
Entrada:  
Cansada e um pouco desmotivada. Só rotina de trabalho, sem festas ou eventos  
Saída:  
<razao>Como a semana está exigente e o humor pede praticidade e leveza, é melhor optar por esmaltação discreta e fácil de manter.</razao>
<sugestao>
<item>Esmalte nude ou bege rosado</item>
<item>Tom translúcido para menor percepção de desgaste</item>
</sugestao>
...
- Proibido responder sem o usuario fornecer informações suficientes. Responda apenas com a mensagem de que precisa de mais detalhes. 

Lembrete:  
Sempre faça o raciocínio antes da sugestão. Descreva claramente como humor e afazeres influenciaram cada sugestão de esmaltação/cor.
`;