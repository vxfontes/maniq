...
export default function Login() {
    ...
    return (
        <div className="min-h-screen min-w-screen bg-gray-900 text-white flex items-center justify-center p-4">
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    <h1 className="text-4xl font-bold mb-2">
                        Bem-vindo ao ManiFodase
                    </h1>
                </div>

                <div className="bg-gray-800 rounded-lg p-8 space-y-6">
                    {error && (
                        <div className="bg-red-900/20 border border-red-500 rounded-md p-3 text-red-300 text-sm text-center">
                            {error}
                        </div>
                    )}
